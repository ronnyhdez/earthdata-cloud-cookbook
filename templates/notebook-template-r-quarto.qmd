...
nasa-metadata:
    - data-collections:
        # For each dataset used, provide at least one of concept-id, short-name, or DOI. 
        # If you have more than one dataset, add more entries to the list.
        - concept-id:
          short-name:
          doi:
        - concept-id:
    ...
    - session-info: # vapply(unname(sessionInfo()$otherPkgs), \(x) paste(x["Package"], x["Version"]), ""). # Would want just the versions of packages, not all revdeps.
